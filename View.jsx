...
const View = () => {
  ...
  {filteredRecord.map((val, index) => (
    <tr key={val.id} align="center">
      ...
      <td>{val.date}</td>
      <td>{val.status}</td>
      <td>{val.emp_city || 'Not Available'}</td>  {/* Handle missing city */}
      <td>{val.emp_salary || 'Not Available'}</td>  {/* Handle missing salary */}
      <td>{val.emp_designation || 'Not Available'}</td>  {/* Handle missing designation */}
      <td>
        <button
